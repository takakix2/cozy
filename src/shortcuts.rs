...
fn file_shortcuts() -> Vec<Shortcut> {
    vec![
        sc(KeyCode::Char('s'), KeyModifiers::CONTROL, EditorAction::EnterSave, "Ctrl+S Save..."),
        sc(KeyCode::Char('s'), KeyModifiers::CONTROL | KeyModifiers::SHIFT, EditorAction::EnterSaveAs, "Ctrl+Shift+S Save As..."),
        sc(KeyCode::Char('o'), KeyModifiers::CONTROL, EditorAction::EnterOpen, "Ctrl+O Open..."),
        sc(KeyCode::Char('b'), KeyModifiers::CONTROL, EditorAction::EnterBrowse, "Ctrl+B Browse..."),
        sc(KeyCode::Char('x'), KeyModifiers::CONTROL, EditorAction::EnterExit, "Ctrl+X Exit..."),
    ]
}
...
fn navigation_shortcuts() -> Vec<Shortcut> {
    vec![
        sc(KeyCode::Char('a'), KeyModifiers::CONTROL, EditorAction::Home, "Ctrl+A Home"),
        sc(KeyCode::Char('e'), KeyModifiers::CONTROL, EditorAction::End, "Ctrl+E End"),
        sc(KeyCode::PageUp, KeyModifiers::NONE, EditorAction::PageUp, "PgUp Prev"),
        sc(KeyCode::PageDown, KeyModifiers::NONE, EditorAction::PageDown, "PgDn Next"),
    ]
}
...
fn edit_shortcuts() -> Vec<Shortcut> {
    vec![
        sc(KeyCode::Char('z'), KeyModifiers::CONTROL, EditorAction::Undo, "Ctrl+Z Undo"),
        sc(KeyCode::Char('y'), KeyModifiers::CONTROL, EditorAction::Redo, "Ctrl+Y Redo"),
        sc(KeyCode::Char('v'), KeyModifiers::CONTROL, EditorAction::Paste, "Ctrl+V Paste"),
    ]
}
...
fn utility_shortcuts() -> Vec<Shortcut> {
    vec![
        ...
        sc(KeyCode::Char('w'), KeyModifiers::CONTROL, EditorAction::ToggleWrap, "Ctrl+W Wrap"),
        sc(KeyCode::Char('k'), KeyModifiers::CONTROL, EditorAction::DeleteLine, "Ctrl+K Cut Line"),
        sc(KeyCode::Char('j'), KeyModifiers::CONTROL, EditorAction::EnterGoto, "Ctrl+J Jump"),
        sc(KeyCode::Char('g'), KeyModifiers::CONTROL, EditorAction::EnterGlide, "Ctrl+G Glide"),
        sc(KeyCode::F(2), KeyModifiers::NONE, EditorAction::ToggleMarkdownPreview, "F2 Markdown"),
    ]
}
...
fn cancel_shortcuts() -> Vec<Shortcut> {
    vec![
        sc(KeyCode::Esc, KeyModifiers::NONE, EditorAction::Cancel, "Esc Cancel"),
        ...
        sc(KeyCode::Char('['), KeyModifiers::CONTROL, EditorAction::Cancel, "Ctrl+[ Cancel"),
    ]
}
...
fn internal_shortcuts() -> Vec<Shortcut> {
    vec![
        sc(KeyCode::Up, KeyModifiers::NONE, EditorAction::MoveUp, "↑ Up"),
        sc(KeyCode::Down, KeyModifiers::NONE, EditorAction::MoveDown, "↓ Down"),
        sc(KeyCode::Left, KeyModifiers::NONE, EditorAction::MoveLeft, "← Left"),
        sc(KeyCode::Right, KeyModifiers::NONE, EditorAction::MoveRight, "→ Right"),
        sc(KeyCode::Enter, KeyModifiers::NONE, EditorAction::Enter, "Enter"),
    ]
}
